...
(1, 1001, 1, 'Construção Residencial', 'Construção de uma casa com três quartos e garagem.', 150000.00, '2024-01-10', '2024-06-10'),
(2, 1002, 2, 'Reforma Comercial', 'Reforma de loja com novo layout e pintura.', 50000.00, '2024-02-01', '2024-04-30'),
(3, 1003, 3, 'Edifício Comercial', 'Construção de um edifício de 10 andares para escritórios.', 500000.00, '2024-03-15', '2025-03-15'),
(4, 1004, 4, 'Casa de Campo', 'Construção de uma casa de campo com área de lazer.', 200000.00, '2024-04-20', '2024-09-20'),
(5, 1005, 5, 'Centro de Eventos', 'Construção de um centro de eventos para grandes conferências.', 700000.00, '2024-05-05', '2025-05-05'),
(6, 1006, 6, 'Ponte de Concreto', 'Construção de uma ponte sobre um rio.', 1200000.00, '2024-06-10', '2025-12-10'),
(7, 1007, 7, 'Área de Lazer', 'Criação de uma área de lazer em um condomínio.', 80000.00, '2024-07-01', '2024-11-01'),
(8, 1008, 8, 'Reforma Residencial', 'Reforma de uma residência com nova fachada e interiores.', 45000.00, '2024-08-15', '2024-11-15'),
(9, 1009, 9, 'Shopping Center', 'Construção de um novo shopping center em área urbana.', 1500000.00, '2024-09-10', '2025-12-10'),
(10, 1010, 10, 'Escola Municipal', 'Construção de uma nova escola com capacidade para 500 alunos.', 600000.00, '2024-10-01', '2025-08-01');